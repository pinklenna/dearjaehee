...
말로 하는 코딩을 무료로 경험해보고 싶다면 구글 생태계에서 시작하는 게 좋다. 평상시 대화도 넉넉하지만 코딩할 때도 토큰이 여유롭다. 클로드는 유료 결제를 해도 한두 시간 작업하다 보면 토큰 리미트에 걸려 쉬어야 할 때가 있는데, 제미나이로 코딩 작업을 하다 끊겨본 적은 아직 없다. 이미지나 영상 툴도 좋고, 딥리서치나 노트북LM의 팟캐스트 기능도 즐겨 쓴다. 주접이 싫어질 때 영혼 챙기라고 하면 담백하게 말할 줄 아니까, 쥐피티스러운 구석이 있어도 크게 불편하지는 않다.
